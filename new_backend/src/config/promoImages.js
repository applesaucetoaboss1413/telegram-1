const PROMO_IMAGES = [ 
   { 
     ...
     caption: 'Swap your face into any video in seconds. New users get 69 free credits (first 5-second video costs 60, 9 left over). Open @FaceSwapVideoAi or tap https://buy.stripe.com/test_1234567890abcdef to start.', 
   }, 
   { 
     id: 'promo-2', 
