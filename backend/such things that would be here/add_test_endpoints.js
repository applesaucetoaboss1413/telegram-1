...
if (idx === -1) { console.error('Express marker not found'); process.exit(1); }
...
const updated = code.slice(0, insertAfter) + addition + code.slice(insertAfter);
fs.writeFileSync(target, updated.replace(/\n/g, '\r\n'));
console.log('Inserted test-friendly endpoints');
