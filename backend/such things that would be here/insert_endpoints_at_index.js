...
if (pos === -1) { console.error('anchor not found'); process.exit(1); }
...
const updated = code.slice(0, insertPos) + addition + code.slice(insertPos);
fs.writeFileSync(target, updated.replace(/\n/g, '\r\n'));
console.log('Inserted endpoints at fixed index');
